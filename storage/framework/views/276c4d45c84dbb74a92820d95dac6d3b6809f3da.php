...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			<?php endif; ?>
			<br>
			<form id="tambahKonferensi" method="post" action="<?php echo e(url('/dosen/biodata-dosen/create')); ?>" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					<label for="judul_penelitian" class="col-sm-2 control-label">NIR</label>
					<div class="col-md-8">
