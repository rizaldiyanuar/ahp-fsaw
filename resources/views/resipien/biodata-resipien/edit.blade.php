...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			{{-- <form id="tambahKonferensi" method="post" action="{{url('/resipien/biodata-resipien/'.$resipien->nir.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal"> --}}
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="datepicker" name="tanggal_lahir_resipien" placeholder="Masukkan Tanggal Lahir Resipien" required>
					</div>
				</div>
